---
title: "Sign In to Streaming Apps on PlayStation and Xbox Consoles"
sidebarTitle: "Game Consoles"
description: "Use an activation code to sign in to your streaming account on PlayStation 4, PlayStation 5, Xbox One, or Xbox Series X/S without a keyboard."
---

PlayStation and Xbox consoles both support activation code sign-in for streaming apps. This is the easiest way to authenticate because it avoids the tedious process of typing an email address and password one character at a time with a controller. Instead, you do the typing on your phone or computer, and the console signs in automatically.
