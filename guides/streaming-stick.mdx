---
title: "Sign In to Streaming Apps on Roku, Fire TV, Apple TV, and Chromecast"
sidebarTitle: "Streaming Sticks"
description: "Activate your streaming account on Roku, Amazon Fire TV Stick, Apple TV, or Chromecast using an activation code on a phone or computer."
---

Streaming sticks and boxes — including Roku, Amazon Fire TV Stick, Apple TV, and Google Chromecast with Google TV — all support the activation code sign-in method. Rather than hunting and pecking through an on-screen keyboard with a remote, you use a phone or computer to authenticate quickly and securely. This guide covers each device so you can get streaming in minutes.
